...
use Basho\Riak\Node;
use Basho\Riak\RObject as RiakObject;
...
class Pb extends Api implements ApiInterface
{
    ...
    protected function parseResponse($message_code, $message = '')
    {
        ...
        switch ($message_code) {
            case Api\Pb\Message::RpbErrorResp:
                ...
                $pbResponse->mergeFromString($message);
    ...
    /**
     * @param Pb\Message\RpbGetReq|Pb\Message\RpbPutReq $message
     * @param Location|null $location
     */
    protected function setLocationOnMessage(&$message, Location $location = null)
    {
        if (!empty($location)) {
     ...
     */
    protected function setBucketOnMessage(&$message, Bucket $bucket = null)
    {
        if (!empty($bucket)) {
    ...
    /**
     * @param |Api\Pb\Message\RpbGetReq|Api\Pb\Message\RpbPutReq|Api\Pb\Message\RpbDelReq $message
     * @param Command $command
     */
    protected function setOptionsOnMessage( &$message, Command $command)
    {
